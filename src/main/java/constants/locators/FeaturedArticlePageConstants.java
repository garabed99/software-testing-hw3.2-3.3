...
public class FeaturedArticlePageConstants {
    public static final String LANGUAGE_BUTTON = "//button[@id='languages-switcher-button']";
    ...
    public static final String GO_TO_EXAMPLES = "//*[@id=\"toc-entries\"]/li[4]/a";
    public static final String EXAMPLE_IFRAME = "//*[@id=\"frame_advanced_example\"]";
    public static final String EXAMPLE_BUTTON = "//*[@id=\"updateDetails\"]";
    ...
    public static final String OUTPUT_RESULT = "/html/body/output";
}
